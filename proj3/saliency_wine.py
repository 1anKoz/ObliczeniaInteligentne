...
scaler = pickle.load(open('./encodings/wine_scaler.sav', 'rb'))
...
for i in range(len(X_test)):
    ...
    # plt.figure()
    # plt.bar(range(len(saliency[0])), saliency[0], tick_label=wine.feature_names)
    # plt.xlabel('Features')
    # plt.ylabel('Saliency')
...
csv_file_path = './saliency_data_wine.csv'
