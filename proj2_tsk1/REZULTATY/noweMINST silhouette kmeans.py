...
def clustering_KMeans(points, n_of_clusters):
    algorithm = cluster.KMeans(n_clusters = n_of_clusters)
...
if __name__ == "__main__":
    ...
    #X_2 = pickle.load(open(".\encodings\J_enc_train_8_features.sav", 'rb'))
    X_2 = pickle.load(open(".\encodings\enc_train_2.sav", 'rb'))
    # /|\ zmieniać
    points_arr1 = X_2
    true_labels_arr1 = []
    for el in Y_train:
        true_labels_arr1.append(int(el))
