...
dataset = ".\dat\MNIST_subset_train_100.sav"
...
class CNNFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Linear(5000, 2)  # Change to desired feature size if needed (100 in this example)
...
with open('./encodings/marta_MNIST_train_2_features.sav', 'wb') as f:
    pickle.dump((train_features, train_labels), f)

with open('./encodings/marta_MNIST_test_2_features.sav', 'wb') as f:
