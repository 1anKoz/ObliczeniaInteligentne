...
plt.xlabel('Epoch')
plt.ylabel('Accuracy (%)')
plt.title('Training and Test Accuracy Over Epochs for CIFAR10 2 ftrs')
plt.legend()
plt.show()
...
def evaluate(model, loader, criterion):
    ...
    plt.ylabel('True')
    plt.title('Confusion Matrix for CIFAR10 2 ftrs')
    plt.show()
...
def plot_decision_boundary(model, features, labels):
    ...
    plt.title('Decision Boundary and Data Points for CIFAR10 2 ftrs')
    plt.show()
